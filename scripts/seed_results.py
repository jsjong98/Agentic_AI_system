...
# Railway 환경이면 /app 기준, 로컬이면 프로젝트 루트 기준
if os.path.exists('/app/results'):
    RESULTS_DIR = '/app/results'
    HR_CSV = '/app/data/IBM_HR.csv'
    SCORE_CSV = '/app/data/Total_score.csv'
else:
    RESULTS_DIR = os.path.join(PROJECT_ROOT, 'app', 'results')
    HR_CSV = os.path.join(PROJECT_ROOT, 'data', 'IBM_HR.csv')
    SCORE_CSV = os.path.join(PROJECT_ROOT, 'Test data', 'Total score.csv')

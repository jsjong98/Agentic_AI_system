...
if __name__ == "__main__":
    ...
    # 실제 텍스트 생성 (API 키가 있을 때만)
    OPENAI_API_KEY = "your-api-key-here"  # 실제 API 키로 변경 필요
    ...
    if OPENAI_API_KEY != "your-api-key-here":
        ...
        print("\n=== 실제 텍스트 생성 시작 ===")
        print("소규모 테스트: 5명에 대해서만 생성합니다...")
        
        # 소규모 테스트로 실행
        generator.generate_all_texts(sample_size=5)
        
        # 결과 저장
        generator.save_to_csv("data/IBM_HR_text_sample.csv")
        generator.save_to_json("data/IBM_HR_text_sample.json")
